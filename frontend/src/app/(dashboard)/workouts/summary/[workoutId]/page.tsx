...
import { getWorkout } from "@/src/features/workout/api";
import {
  getGreyShadeCSS,
  getOrdinalSuffix,
  getTime,
...
export default async function WorkoutSummary({
  ...
  return (
    <div className="container">
      ...
      {/* <span className="text-center block w-full text-2xl p-8">
        {workoutCount}
        {getOrdinalSuffix(workoutCount)} workout
      </span>*/}
